...
#include "endian.h" //needed this, otherwise compiling errors occur

void readChar(FILE *f, int swap, char *c){
	
	
	fread(c, 1, 1, f); // read chars (size of one byte), no swaps needed
...
void readString(FILE *f, int swap, char *c){
	// no swaps needed
	char str; //initialize a character or element of the string
